# #45: Autopsy: Investigate artefacts from disk image ⚔️
...
This room was **one of the challenging** one in a while — I needed to reference outside help for some sections.

Despite that, I learned a lot about **how Autopsy organizes data**, from registry information to file system metadata, and how to **build reports and visualize timelines**.

It was a great practical experience combining previous Windows Forensics knowledge with **GUI-based forensic analysis**.
